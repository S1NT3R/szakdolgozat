...
mixin _$UserModel {
  ...
  String? get lastStreakUpdate => throw _privateConstructorUsedError;
...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, email: $email, picture: $picture, streak: $streak, lastStreakUpdate: $lastStreakUpdate)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, email, picture, streak, lastStreakUpdate);
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      required final String? lastStreakUpdate}) = _$UserModelImpl;
